                          ...
                          <details className="drill-record-group" key={record.id}>
                            ...
                            <div className="drill-record-body">
                              <div className="drill-meta">
                                ...
                                {record.benchName ? <span>Cava: {normalizeDrillingBankName(record.benchName)}</span> : null}
